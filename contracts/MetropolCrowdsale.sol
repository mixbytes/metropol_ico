 ...
 * MetropolCrowdsale
 */
contract MetropolCrowdsale is
    TokensBurnableReturnableCrowdsale,
    Ownable // only for trying to buy before ico official start
{
//TODO !!!!!!!!! UPDATE FundsRegistryWalletConnector to delete detach controller on fail
    ...
    function MetropolCrowdsale(
        ...
        TokensBurnableReturnableCrowdsale(_token, _owners, 2)
        public
    {
